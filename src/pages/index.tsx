      ...
      <main className='text-white'>
       ...
       bg-black bg-opacity-50 rounded-lg max-w-3xl`}
        >
          ...
          <p className='sm:p-4 sm:text-base text-sm'>
            ...
            Then collaborate with GPT-4 to refine and expand the content. Add
            new subarticles to build out a complete tree of in-depth,
            high-quality information tailored to your needs.
          </p>
